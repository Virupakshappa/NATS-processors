...
//        props.add(PRODUCER_TYPE);
    ...
    public void onTrigger(final ProcessContext context, final ProcessSession session) throws ProcessException {
        ...
        if (delimiter == null) {
            ...
            boolean error = false;
            final AtomicLong  lastMessageOffset = new AtomicLong (0L);
                        ...
                        try (final InputStream bufferedIn = new BufferedInputStream(rawIn);
                            ...
                            while (!streamFinished) {
                                ...
                                if (nextByte == -1) {
                                    ...
                                    data = Arrays.copyOfRange(baos.toByteArray(), 0, baos.size() - delimiterBytes.length);
                                }
            ...
            } catch (final ProcessException | IOException pe) {
                error = true;
